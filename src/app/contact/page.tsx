...
const faqs = [
  {
    ...
    answer:
      'It depends on the project scope. Standard websites typically take 2-4 weeks, while complex web applications can take 6-12 weeks. We provide a detailed timeline during the initial consultation.',
  },
  {
    question: 'Do you offer post-launch support?',
    answer:
      'Absolutely. We provide 30 days of free support after launch to ensure everything runs smoothly. After that, we offer flexible maintenance packages to keep your software secure and up-to-date.',
  },
  {
    question: 'How do you handle project payments?',
    answer:
      'We typically work with a 50% deposit to start the project, with the remaining balance due upon successful delivery and your final approval.',
  },
  {
    question: 'Can you help with hosting and domain setup?',
    answer:
      "Yes, we handle the entire technical setup including domain registration, secure hosting configuration, and SSL implementation so you don't have to worry about the details.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Have a project in mind? We&apos;d love to hear about it. Reach out to us and we&apos;ll
                ...
                {[
                  {
                    icon: Facebook,
                    label: 'Facebook',
                    href: 'https://www.facebook.com/profile.php?id=61587168062633',
                  },
                  {
                    icon: Instagram,
                    label: 'Instagram',
                    href: 'https://www.instagram.com/delix4_?igsh=NDAxOXlzdjJyZG15',
                  },
                  {
                    icon: Linkedin,
                    label: 'LinkedIn',
                    href: 'https://www.linkedin.com/company/delix4',
                  },
                ].map((social, idx) => (
                  <a
                    key={idx}
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full ${openFaq === index ? 'bg-primary text-black' : 'bg-white/10 text-white'}`}
                  >
                    {openFaq === index ? (
