...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-black selection:bg-primary/30 selection:text-white pt-36 lg:pt-32"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              We architect scalable digital solutions that drive growth. From enterprise platforms
              to immersive web experiences, Delix4 is your partner in digital transformation.
            </motion.p>
