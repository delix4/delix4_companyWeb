...
const projects = [
    {
        ...
        description: "A full-featured online store with real-time inventory management, secure payments, and AI-driven product recommendations.",
        image: "/banner.jpg",
    ...
    },
    {
        ...
        description: "Real-time financial analytics dashboard for a leading investment firm, processing millions of data points daily.",
        image: "/banner.jpg",
    ...
    },
    {
        ...
        category: "Mobile App",
        description: "Cross-platform mobile application for tracking workouts, nutrition, and connecting with personal trainers.",
        image: "/banner.jpg",
    ...
    },
    {
        ...
        description: "Complete digital rebranding for a global logistics company, including website, design system, and marketing assets.",
        image: "/banner.jpg",
    ...
    },
    {
        ...
        description: "Centralized control interface for smart home devices, featuring voice control integration and energy monitoring.",
        image: "/banner.jpg",
    ...
    },
    {
        ...
        category: "Mobile App",
        description: "AI-powered travel planner that creates personalized itineraries and provides real-time local recommendations.",
        image: "/banner.jpg",
        tech: ["Flutter", "OpenAI API", "Google Maps"],
    },
];

const categories = ["All", "Web Development", "Mobile App", "Branding & Design", "IoT Solution", "Web Application"];
